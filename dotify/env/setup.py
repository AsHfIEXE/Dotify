        ...
        try:
            ...
            if not config_file.exists():
                config_file.write_text(
                    ...
                    "# Run 'dotify env doctor' to check your setup\n"
                    "# Run 'dotify init' to configure interactively\n"
                    "\n"
                    "# Paths\n"
                    f"cookies_path = {self.paths.default_cookies_path}\n"
                    "cookies_from_browser = null\n"
                    "browser_profile = null\n"
                    f"wvd_path = {self.paths.default_wvd_path}\n"
                    "output = ./Spotify\n"
                    f"temp = {self.paths.temp_dir}\n"
                    "\n"
                    "# Download settings\n"
                    "wait_interval = 10\n"
                    ...
                    f"queue_state_path = {self.paths.config_dir / 'queue.json'}\n"
                    "resume = true\n"
                    "\n"
                    "# Logging\n"
                    "log_level = INFO\n"
